...
call s:hi('LineNr'                      , 222           , s:bg-1        , 'None'            , 'None'            )
call s:hi('CursorLine'                  , ''            , s:bg-1        , 'None'            , 'None'            )
call s:hi('CursorLineNr'                , 170           , s:bg-1        , 'None'            , 'None'            )
call s:hi('CursorColumn'                , ''            , s:bg-1        , 'None'            , 'None'            )
call s:hi('ColorColumn'                 , ''            , s:bg-1        , 'None'            , 'None'            )
call s:hi('WildMenu'                    , 214           , s:bg+3        , 'None'            , 'None'            )
...
call s:hi('DiffAdd'                     , 142           , 235           , 'reverse'         , 'bold'            )
call s:hi('DiffChange'                  , 107           , 235           , 'reverse'         , 'bold'            )
call s:hi('DiffDelete'                  , 160           , 235           , 'reverse'         , 'bold'            )
call s:hi('DiffDelete'                  , 160           , 235           , 'reverse'         , 'bold'            )
call s:hi('DiffText'                    , 214           , 235           , 'reverse'         , 'bold'            )
...
call s:hi('FoldColumn'                  , 67            , s:bg+1        , 'None'            , 'None'            )
call s:hi('Folded'                      , 133           , s:bg+1        , 'bold'            , 'bold'            )
...
call s:hi('MatchParen'                  , 40            , s:bg+1        , 'bold,underline'  , 'bold,underline'  )
call s:hi('ModeMsg'                     , 229           , ''            , 'None'            , 'None'            )

" Popup menu
call s:hi('Pmenu'                       , 141           , s:bg+1        , 'None'            , 'None'            )
...
call s:hi('VertSplit'                   , 232           , 0             , 'None'            , 'None'            )
...
call s:hi('Visual'                      , ''            , s:bg+3        , 'None'            , 'None'            )
call s:hi('VisualNOS'                   , ''            , s:bg+3        , 'None'            , 'None'            )

" tilde group
call s:hi('NonText'                     , 232           , ''            , 'None'            , 'None'            )
...
" vim_current_word
call s:hi('CurrentWord'                 , ''            , s:bg+1        , 'underline'       , 'underline'       )
call s:hi('CurrentWordTwins'            , ''            , s:bg+1        , 'none'            , 'none'            )
