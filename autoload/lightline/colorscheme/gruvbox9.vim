...
let s:p = {'normal':{}, 'inactive':{}, 'insert':{}, 'replace':{}, 'visual':{}, 'tabline':{}, 'terminal':{}}
  let s:p.normal.left = [ [ s:bg0, s:blue, 'bold' ], [ s:fg4, s:bg3] ,[s:fg3,s:bg4],[s:blue1,s:bg_icon]]
  let s:p.normal.right = [ [ s:bg0, s:blue], [ s:bg0, s:fg4 ],[ s:bg0, s:bg4 ] ,[s:red,s:bg1],[s:blue1,s:bg1],[s:orange,s:bg1]]
  ...
  let s:p.terminal.left = [ [ s:bg0, s:blue, 'bold' ], [ s:fg1, s:bg2 ] ]
  let s:p.terminal.right = [ [ s:bg0, s:blue], [ s:fg1, s:bg2 ] ]
